...
namespace Eco.Serialization
{
	static class SerializableTypeEmitter
	{
		public static Type GetSerializableTypeFor<T>(ISerializationAttributesGenerator attributesGenerator, Usage defaultUsage)
		{
			...
			return Emit(typeof(T), attributesGenerator, GetSerializableFieldType, defaultUsage);
		}
		...
		public static string GenerateClassDefinitionRecursevely(Type root, ISerializationAttributesGenerator attributesGenerator, Func<FieldInfo, Type> GetSerializableFieldType, Usage defaultUsage)
		{
